...
function EditPost({
    ...
    async function updateEditedPost() {
        ...
        await API.graphql({
            query: updatePost,
            variables: { input: { id, title, content, ...(coverImage && { coverImage: post?.coverImage }) } },
    ...
    return (
        <div>
            ...
            />
            { coverImage && <img src={typeof coverImage !== 'string' ? URL.createObjectURL(coverImage) : coverImage} className='mt-4' /> }
